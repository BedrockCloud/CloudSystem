...
namespace bedrockcloud\library;
...
final class LibraryManager {
    ...
    public function load(): void {
        foreach ($this->libraries as $library) {
            ...
            if ($library->canBeLoaded()) BedrockCloud::getInstance()->getClassLoader()->addPath($library->getClassLoadFolder(), $library->getClassLoadPath());
        }
    }
